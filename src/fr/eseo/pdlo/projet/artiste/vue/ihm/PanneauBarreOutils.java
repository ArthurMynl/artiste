...
import fr.eseo.pdlo.projet.artiste.controleur.actions.ActionChoisir;
...
public class PanneauBarreOutils extends JPanel {
        ...
        private void initBoutonsActionsIndependantes() {
                ...
                JToggleButton boutonChoisir = new JToggleButton(new ActionChoisir(panneauDessin));
                ...
                boutonChoisir.setName(ActionChoisir.NOM_ACTION);
                boutonChoisir.setText(ActionChoisir.NOM_ACTION);
        ...
        private void initBoutonsOutils() {
                ...
                JToggleButton boutonArrierePlan = new JToggleButton(
                                new ActionChangerPlan(panneauDessin, ActionChangerPlan.NOM_ACTION_ARRIERE_PLAN));
                JToggleButton boutonPremierPlan = new JToggleButton(new ActionChangerPlan(panneauDessin,
                                ActionChangerPlan.NOM_ACTION_PREMIER_PLAN));
                JToggleButton boutonPlanDessus = new JToggleButton(new ActionChangerPlan(panneauDessin,
                                ActionChangerPlan.NOM_ACTION_PLAN_SUPERIEUR));
                JToggleButton boutonPlanDessous = new JToggleButton(
                                new ActionChangerPlan(panneauDessin, ActionChangerPlan.NOM_ACTION_PLAN_INFERIEUR));
                ...
                spinnerNbCotesPolygone
                                .addChangeListener(new ActionChoisirNombrePoints(panneauDessin, this, boutonPolygone));
                ...
                spinnerNbCotesEtoile.addChangeListener(
                                new ActionChoisirNombrePointsEtoile(panneauDessin, this, boutonEtoile));
                ...
                boutonArrierePlan.setName(ActionChangerPlan.NOM_ACTION_ARRIERE_PLAN);
                boutonPremierPlan.setName(ActionChangerPlan.NOM_ACTION_PREMIER_PLAN);
                boutonPlanDessus.setName(ActionChangerPlan.NOM_ACTION_PLAN_SUPERIEUR);
                boutonPlanDessous.setName(ActionChangerPlan.NOM_ACTION_PLAN_INFERIEUR);
                ...
                buttonGroup.add(boutonArrierePlan);
                buttonGroup.add(boutonPremierPlan);
                buttonGroup.add(boutonPlanDessus);
                buttonGroup.add(boutonPlanDessous);
                ...
                this.add(boutonArrierePlan);
                this.add(boutonPremierPlan);
                this.add(boutonPlanDessus);
                this.add(boutonPlanDessous);
        }
